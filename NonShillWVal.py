...
def train_and_evaluate_model():
    ...
    # Total data: 100%
    # (70:15:15) Langkah 1: Bagi menjadi Train+Val (85%) dan Test (15%)
    X_train_val, X_test, y_train_val, y_test = train_test_split(features_scaled, labels_encoded, 
        test_size=0.15, 
        random_state=42, 
        stratify=labels_encoded)
    # Langkah 2: Bagi Train+Val menjadi Train (82.35%) dan Val (17.65%) dari total 85% = 70% Train, 15% Val
    X_train, X_val, y_train, y_val = train_test_split( X_train_val, y_train_val,
        test_size=0.15/0.85,  # 0.25 x 0.8 = 0.2 (20%)
        random_state=42,
        stratify=y_train_val)

#----------------------------------------------    
    # #Langkah 1: Bagi menjadi Train+Val (80%) dan Test (20%)
    # X_train_val, X_test, y_train_val, y_test = train_test_split(features_scaled, labels_encoded, 
    #     test_size=0.2, 
    #     random_state=42, 
    #     stratify=labels_encoded)
    # # Langkah 2: Bagi Train+Val (80%) menjadi Train (60%) dan Val (20%)
    # X_train, X_val, y_train, y_val = train_test_split( X_train_val, y_train_val,
    #     test_size=0.25,  # 0.25 x 0.8 = 0.2 (20%)
    #     random_state=42,
    #     stratify=y_train_val)

#----------------------------------------------    
    # #(80:10:10)Langkah 1: Bagi menjadi Train+Val (90%) dan Test (10%)
    # X_train_val, X_test, y_train_val, y_test = train_test_split(features_scaled, labels_encoded, 
    #     test_size=0.1, 
    #     random_state=42, 
    #     stratify=labels_encoded)
    # # Langkah 2: Bagi Train+Val (88.89%) dan Val (11.11%) dari total 90% = 80% Train, 10% Val
    # X_train, X_val, y_train, y_val = train_test_split( X_train_val, y_train_val,
    #     test_size=(0.1/0.9),  
    #     random_state=42,
    #     stratify=y_train_val)
...
#------------------------------------------
    ...
    best_config = analyze_distances(X_train, X_val, y_train, y_val)
    ...
    # Gabungkan train dan validation untuk training final
    ...
    # Perbesar teks dalam kotak (annotasi angka)
